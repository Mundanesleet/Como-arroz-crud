/* =========================================================
   ...
   Antes este archivo tenía el catálogo hardcodeado. Ahora lo
   carga desde la API de Django (/api/menu/productos/), que lee
   categorías/productos/variantes de la base de datos.
